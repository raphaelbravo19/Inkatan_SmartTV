...
var arrayElements = [
	'<div id="player1" class="itemPlayer"><div id="avatar1" class="avatar turnActive" style="border-radius: ' + widthHtml * 0.07 + 'px;width:' + widthHtml * 0.14 + 'px; height:' + widthHtml * 0.14 + 'px"><img id="userImage1" class="user" src="../../Assets/icons/user.png" style="width:' + widthHtml * 0.12 + 'px; height:' + widthHtml * 0.12 + 'px"/></div><div id="playerName1" class="playerName" style="font-size:' + widthHtml * 0.022 + 'px">',
	'<div id="player2" class="itemPlayer"><div id="avatar2" class="avatar " style="border-radius: ' + widthHtml * 0.07 + 'px;width:' + widthHtml * 0.14 + 'px; height:' + widthHtml * 0.14 + 'px; background: #ffdf2e"><img id="userImage2" class="user" src="../../Assets/icons/user.png" style="width:' + widthHtml * 0.12 + 'px; height:' + widthHtml * 0.12 + 'px"/></div><div id="playerName2" class="playerName" style="font-size:' + widthHtml * 0.022 + 'px">',
	'<div id="player3" class="itemPlayer"><div id="avatar3" class="avatar " style="border-radius: ' + widthHtml * 0.07 + 'px;width:' + widthHtml * 0.14 + 'px; height:' + widthHtml * 0.14 + 'px; background: #d017ff"><img id="userImage3" class="user" src="../../Assets/icons/user.png" style="width:' + widthHtml * 0.12 + 'px; height:' + widthHtml * 0.12 + 'px"/></div><div id="playerName3" class="playerName" style="font-size:' + widthHtml * 0.022 + 'px">',
	'<div id="player4" class="itemPlayer"><div id="avatar4" class="avatar " style="border-radius: ' + widthHtml * 0.07 + 'px;width:' + widthHtml * 0.14 + 'px; height:' + widthHtml * 0.14 + 'px; background: #ff682e"><img id="userImage4" class="user" src="../../Assets/icons/user.png" style="width:' + widthHtml * 0.12 + 'px; height:' + widthHtml * 0.12 + 'px"/></div><div id="playerName4" class="playerName" style="font-size:' + widthHtml * 0.022 + 'px">'
]
